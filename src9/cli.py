...
def get_args():
    ...
    parser.add_argument('-unitary_lr', '--learning-rate-unitary', help='Learning rate', type=float, required=True)
    ...
    parser.add_argument('-cu', '--cuda', help='Cude device number', type=str, required=False)
    ...
    parser.add_argument('--CMT-nheads', help='Number of heads of the CMT', type=int, required=False, default=1)
    parser.add_argument('--CMT-layers', help='Number of layers of the CMT', type=int, required=False, default=1)
    ...
    parser.add_argument('--CMT-dropout',  help='CMT-dropout', type=float, required=False, default=0.35)
